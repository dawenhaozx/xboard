...
class SingBoxNew
{
    ...
    {
        $defaultConfig = base_path('resources/rules/default.sing-box-new.json');
        $customConfig = base_path('resources/rules/custom.sing-box-new.json');
